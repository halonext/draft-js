...
var DraftEditorCompositionHandler = {
  ...
  resolveComposition: function resolveComposition(editor) {
    ...
    mutations.forEach(function (composedChars, offsetKey) {
      ...
      var startBlock = contentState.getBlockForKey(blockKey);
      var key = startBlock.getEntityAt(start);
      var entity = key ? contentState.getEntityMap().__get(key) : null;

      if (start === 0 && entity) {
        var text = composedChars;
