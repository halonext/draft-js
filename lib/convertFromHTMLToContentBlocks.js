...
var newLineRegexp = /^(h[1-6]|div|p|li|figure)$/g;
...
var ContentBlocksBuilder = /*#__PURE__*/function () {
  ...
  function ContentBlocksBuilder(blockTypeMap, disambiguate) {
    ...
    _defineProperty(this, "blockConfig", {});
  ...
  _proto._toOneBlockConfigs = function _toOneBlockConfigs(nodes, beforeChildren) {
    var result = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;

    for (var i = 0; i < nodes.length; i++) {
      var node = nodes[i];
      var nodeName = node.nodeName.toLowerCase();
      var childNodes = Array.from(node.childNodes); // add newline before block node
  ...
  _proto._appendText = function _appendText(text) {
    ...
    var style = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : OrderedSet();
