...
var DraftEditor = /*#__PURE__*/function (_React$Component2) {
  ...
  _proto2._showPlaceholder = function _showPlaceholder() {
    if (!this.props.placeholder || this.props.editorState.getCurrentContent().hasText()) {
      return false;
    }

    return !this.props.editorState.isInCompositionMode() && this.props.editorState.getCurrentContent().getFirstBlock().type === 'unstyled';
  };
